    ...
    return (
        <div className="h-fit flex-1 overflow-auto w-full flex flex-col gap-4 p-4">
            ...
            <div className="flex flex-row justify-center gap-4 mt-4">
                <button
                    onClick={() =>
                        router.push(`/admin/sessions/summary/session/${slug}`)
                    }
                        ...
                        <Card key={game._id} className="">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    ...
                                    {game?.end
                                        ? format(new Date(game.end), 'hh:mm a')
                                        : 'TBA'}{' '}
                                    {game?.end && (
                            ...
                            <CardContent>
                                <div className="w-full flex flex-row justify-between">
                                    <div className="flex flex-col">
                                        ...
                                        {game.A2.name && (
                                            <span>{game.A2.name}</span>
                                        )}
                                    </div>
                                    <div className="flex flex-col">
                                        <span>{game.B1.name}</span>
                                        {game.B2.name && (
                                            <span>{game.B2.name}</span>
                                        )}
                                    </div>
                                </div>
