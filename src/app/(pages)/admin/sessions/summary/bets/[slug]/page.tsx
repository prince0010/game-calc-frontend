                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="text-xl font-semibold border-b pb-2 flex items-center justify-between">
                            <div className="flex items-center">
                                <NotebookTabs className="w-6 h-6 text-green-500 mr-3" />{' '}
                                Bettors Lists
                                {selectedBetType && (
                    ...
                    <CardContent>
                        <Accordion type="single" collapsible className="w-full">
                            {sessionBetsSummary?.playerStats.map(
                                (player: any) => (
                                    <AccordionItem
                                        key={player.user._id}
                                    ...
                                    >
                                        <AccordionTrigger className="w-full flex justify-between items-center p-4 hover:bg-gray-50 transition-colors">
                                            ...
                                            <span className="text-sm text-gray-800">
                                              <span className='font-bold text-green-500'> Wins: </span> <span className='font-bold'>{player.wins}</span> |  <span className='font-bold text-red-500'> Losses: </span>  <span className='font-bold'>{player.losses}</span> |  <span className='font-bold text-blue-500'> Total: </span> <span className='font-bold'>{player.total}</span>
                                            </span>
                                        </AccordionTrigger>
